...
[![checks](https://github.com/CompleteDotTech/jev-harness/actions/workflows/checks.yml/badge.svg)](https://github.com/CompleteDotTech/jev-harness/actions/workflows/checks.yml)
[MIT](LICENSE) · Node 22+ · pnpm · source-only, not published

**Repository provenance:** this is the `CompleteDotTech/jev-harness` fork of
[the TypeSafeAI community upstream](https://github.com/TypeSafeAI/jev-harness).
The community upstream is not the official TypeSafe AI team. Neither repository
is an official SDK or endorsed production agent runtime. Official product
resources are [typesafe.ai](https://typesafe.ai) and [docs.typesafe.ai](https://docs.typesafe.ai).
The badge above is for this fork; an upstream badge is not local CI evidence.

## Quick start

```sh
git clone https://github.com/CompleteDotTech/jev-harness.git
cd jev-harness
...
## Historical measurements: upstream, not new results from this fork
...
[SECURITY.md](SECURITY.md). Use this fork's [issue tracker](https://github.com/CompleteDotTech/jev-harness/issues)
for non-sensitive local questions and [private security reporting](https://github.com/CompleteDotTech/jev-harness/security/advisories/new)
...
Upstream coordination is separate and does not replace this fork's review.
