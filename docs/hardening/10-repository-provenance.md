...
This fork is `CompleteDotTech/jev-harness`. Its upstream is the independent
TypeSafeAI community repository, not TypeSafe AI's official SDK or product team.
The README clone command and CI badge, issue contact links, and private security
reporting destination now identify this fork. Upstream historical measurements
