...
Report vulnerabilities affecting this fork through
[CompleteDotTech/jev-harness private reporting](https://github.com/CompleteDotTech/jev-harness/security/advisories/new)
...
Coordinate upstream reports separately with the affected upstream maintainers;
an upstream reporting link is not this fork's private channel.
...
remote settings are enabled. Maintainers must verify this fork's Actions
